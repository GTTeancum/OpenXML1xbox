...
foreach ($patchName in @('xboxrecomp-xml1-memory.patch', 'xboxrecomp-flag-joins.patch', 'xboxrecomp-dsp-integration.patch', 'xboxrecomp-kernel-abi.patch', 'xboxrecomp-stereo-output.patch')) {
